...
import AddSolarOwnersStep from './AddSolarOwnersStep';
import { toast, ToastContainer } from 'react-toastify';

interface AddSolarModalProps {
  name: string;
  description: string;
  ownersCount: number;
  addressList: string[];
...
const AddSolarModal: React.FC<AddSolarModalProps> = ({
  name,
  description,
  ownersCount,
  addressList,
