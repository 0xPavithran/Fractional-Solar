// components/SolarDetailModal.tsx
import React, { useEffect } from 'react';

interface SolarDetailModalProps {
  name: string;
  description: string;
...
const SolarDetailModal: React.FC<SolarDetailModalProps> = ({ name, description, viewerAddress,  addresses, sharePercentages, onClose }) => {
...
export default SolarDetailModal;
